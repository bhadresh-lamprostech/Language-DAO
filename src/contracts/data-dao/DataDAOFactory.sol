...
contract DataDoaFactory{
    ...
    function createDataDao(address _dataDAOAddress, string memory _name, string memory _description, IERC20 _token, uint _tokenPrice, uint _totalSupply) public {       
    ...
    function getAllDataDaos() public view returns(dataDaoFactoryStruct[] memory){
        dataDaoFactoryStruct[] memory DataDaos = new dataDaoFactoryStruct[](allDataDaosAddress.length);
    ...
    function getUserDataDaos(address _userAddress) public view returns(dataDaoFactoryStruct[] memory){
        dataDaoFactoryStruct[] memory DataDaos = new dataDaoFactoryStruct[](userDataDAO[_userAddress].length);
    ...
    function getDataDaoInstance(uint256 id) public view returns(dataDaoFactoryStruct memory)
    {
