...
import "../styles/sdao.scss";

const dataDaoFactoryContract = "0x8428C82cFf9F7B5b25E2b54C7DF663Fe0002526a";

function SamithaDaos({ setSingleYourDataDao, setYourDaos, setDaoAddress }) {
  ...
  const getAllDataDaos = async () => {
    ...
    const dataDaos = await contract.getUserDataDaos(
      "0x7dD1926B51d493dcB6eE58b5DE77FcD17D0Bc0F3"
    );
    ...
    <>
      <div className="all-datadao-main-div">
        <div className="all-datadao-div">
          ...
          <div className="sdao-all-datadao-section2">
            ...
            {allDataDaos.length > 0 ? (
              allDataDaos.map((dao) => (
                <div className="sdao-details">
                  <div className="sdao-name">{dao.dataDaoName}</div>
                  <div className="sdao-description">
                    {dao.dataDaoDescription}
                  </div>
                  <div className="sdao-address">
                    <h3>
                      {dao.dataDaoAddress.substring(0, 6) +
                        "..." +
                        dao.dataDaoAddress.substring(
                    ...
                    <svg
                      ...
                      onClick={() => copyContent(dao.dataDaoAddress)}
                    >
                      <g>
